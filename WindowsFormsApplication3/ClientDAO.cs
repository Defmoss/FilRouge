  ...
  class ClientDAO
        {
          ...
          public ClientDAO(string phrase)
         {
           ...
           public Client Find(int id)
          {
           ...
           {
            connect.Open();
            SqlCommand requete = new SqlCommand("insert into client (nom_client,prenom_client,sexe_client,date_naiss_client,adress_client,code_postal,telephone_client,mail_client) values (@nom,@prenom,@sexe,@date,@adress,@code_postal,@telephone,@mail)", connect);
